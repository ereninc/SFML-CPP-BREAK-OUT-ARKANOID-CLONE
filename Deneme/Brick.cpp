...
void Brick::Random()
{
	...
	if (b == 1) fileName3 = "resimler/brick_blue_small.png";
	if (b == 2) fileName3 = "resimler/brick_green_small.png";
	if (b == 3) fileName3 = "resimler/brick_pink_small.png";
	if (b == 4) fileName3 = "resimler/brick_violet_small.png";
	if (b == 5) fileName3 = "resimler/brick_yellow_small.png";
}
